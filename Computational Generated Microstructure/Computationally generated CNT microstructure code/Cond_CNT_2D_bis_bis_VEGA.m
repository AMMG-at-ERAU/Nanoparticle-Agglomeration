mycluster11bisbis=parcluster('local');
mycluster11bisbis.NumWorkers=60;
parpool(mycluster11bisbis,60,'SpmdEnabled',false);
Number = 5000;
...
while count<0.5
    ...
    parfor ii = 1:Number
        ...
        %0.0001
        RVE.Vf = 0.044 + 0.0005*(jj-1); %CNT area fraction
        ...
        [~, Nj, Gn, perco ] = ResNetwork_Soft_leafs_notouch_Nj_Perco(dCNT, ja, Ptrue1, RVE); %find the network resistance matrix
        ...
        disp(['// Voulume fraction = ',num2str(RVE.Vf),' S'])
    ...
    count = kkk/i;
disp(['// Perco = ',num2str(count)])

    
end

save('CNT_Cond_2D_Vf8.33p_agg_10p_angle_45d_rad_16L-over-100_5000_M.mat','Total')
