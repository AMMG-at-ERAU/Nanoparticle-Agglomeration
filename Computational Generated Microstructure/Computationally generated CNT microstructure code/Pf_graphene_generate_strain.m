function [ gh1,gh2,PPg ] = Pf_graphene_generate_strain( ae,be,Lx,Ly,perc,Vf,Area,nber )
...
% %     alpha=mi + (ma-mi)*rg(3,:);
  ...
  for j=1:siz
        ...
        for i=1:nber %since 0 and 2*pi are the same take away 2*pi
