myclusterHoleCondS=parcluster('local');
myclusterHoleCondS.NumWorkers=36;
parpool(myclusterHoleCondS,35,'SpmdEnabled',true);
...
parfor ii = 1:Number
    ...
    RVE.perc = 0.03/RVE.Vf; %percentage of CNT fraction for GNP particles
...
Data = Data(1);
save('Hybrid_Hole_Cond_2D_Vf12p_G3p_agg_0p_Hole_rad_Lover20_number_(2_2_20)_5000.mat','result1','Junct_CNT','Junct1_CNT','Junct2_CNT','Junct_GNP','Junct1_GNP','Junct2_GNP','Junct','Junct1','Junct2','FLAG','Data')
