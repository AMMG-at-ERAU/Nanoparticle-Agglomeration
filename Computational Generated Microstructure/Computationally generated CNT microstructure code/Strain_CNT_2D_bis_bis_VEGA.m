...
% end
% save('CNT_Strain_2D_Vf9.55+20p_agg_10p_angle_45d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
% 
% parfor ii = 1:Number
%     rng(ii)
%     format long
...
% %     disp(['// Junct = ',num2str(Junct(ii,:)),' %']);
% end
% save('CNT_Strain_2D_Vf9.20+20p_agg_20p_angle_45d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
% 
% parfor ii = 1:Number
%     rng(ii)
%     format long
...
% 
% 
%     RVE.Vf = 0.0970 + 0.20; %CNT area fraction
...
% %     disp(['// Junct = ',num2str(Junct(ii,:)),' %']);
% end
% save('CNT_Strain_2D_Vf9.70+20p_agg_30p_angle_45d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
% 
% parfor ii = 1:Number
%     rng(ii)
%     format long
...
% 
% 
%     RVE.Vf = 0.0965 + 0.20; %CNT area fraction
...
% %     disp(['// Junct = ',num2str(Junct(ii,:)),' %']);
% end
% save('CNT_Strain_2D_Vf9.65+20p_agg_40p_angle_45d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
% 
% parfor ii = 1:Number
%     rng(ii)
%     format long
...
% 
% 
%     RVE.Vf = 0.1040 + 0.20; %CNT area fraction
...
% %     disp(['// Junct = ',num2str(Junct(ii,:)),' %']);
% end
% save('CNT_Strain_2D_Vf10.40+20p_agg_50p_angle_45d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
% 
% parfor ii = 1:Number
%     rng(ii)
%     format long
...
% 
% 
%     RVE.Vf = 0.1115 + 0.20; %CNT area fraction
...
% %     disp(['// Junct = ',num2str(Junct(ii,:)),' %']);
% end
% save('CNT_Strain_2D_Vf11.15+20p_agg_60p_angle_45d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
% 
% parfor ii = 1:Number
%     rng(ii)
%     format long
...
% 
% 
%     RVE.Vf = 0.1240 + 0.20; %CNT area fraction
...
% %     disp(['// Junct = ',num2str(Junct(ii,:)),' %']);
% end
% save('CNT_Strain_2D_Vf12.40+20p_agg_70p_angle_45d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
% 
% parfor ii = 1:Number
%     rng(ii)
%     format long
...
% 
% 
%     RVE.Vf = 0.1375 + 0.20; %CNT area fraction
...
% %     disp(['// Junct = ',num2str(Junct(ii,:)),' %']);
% end
% save('CNT_Strain_2D_Vf13.75+20p_agg_80p_angle_45d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.2195 + 0.20; %CNT area fraction
...
save('CNT_Strain_2D_Vf21.95+20p_agg_90p_angle_45d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
delete(gcp('nocreate'))
