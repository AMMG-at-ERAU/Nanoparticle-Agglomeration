mycluster1bisbis=parcluster('local');
mycluster1bisbis.NumWorkers=60;
parpool(mycluster1bisbis,60,'SpmdEnabled',true);
Number = 5000;
%Vof = [0.02:0.00275:0.0695 0.0722:0.00275:0.12995  0.15:0.05:0.4];
Vof = [0.12170:0.00275:0.12995 0.15:0.05:0.4];
lVof = length(Vof);
count = zeros(lVof,3);
for jj = 1:lVof
...
save('CNT_Cond_data_2D_agg_70p_angle_0d_rad_2L-over-100_5000.mat','count')
end
