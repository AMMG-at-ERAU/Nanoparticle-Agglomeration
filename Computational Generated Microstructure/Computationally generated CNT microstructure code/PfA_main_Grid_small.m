...
RVE.nBin = 25;                                %number of grids/bins in each direction


%% form CNT network
[ Ptrue1, Center1, Length,~,~,~] = A_GenerateHardCore_Grids_small_boxp_PBC(RVE);    %Generate the CNT
pipi=Ptrue1';
n=size(pipi,2);
Linit = RVE.size;
...
toc
tic
[Gn, perco ] = A_ResNetwork_Soft_leafs_notouch(dCNT, ja, PP', RVE); %find the network resistance matrix
toc
