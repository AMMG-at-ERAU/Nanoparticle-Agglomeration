myclusterSn=parcluster('local');
myclusterSn.NumWorkers=60;
parpool(myclusterSn,60,'SpmdEnabled',false);
Number = 5000;
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.084; %CNT area fraction
    ...
    %[ Ptrue, Center, Length, Angle, ~, ~, ~ ] = CNT_generate_agglo_angle( RVE); %Weibull length + Alignment angle
...
save('Hybrid_Strain_2D_C8.4p_G20p_agg_0p_rad_L-over-100_5000_Perco.mat','result1','Junct','FLAG')
