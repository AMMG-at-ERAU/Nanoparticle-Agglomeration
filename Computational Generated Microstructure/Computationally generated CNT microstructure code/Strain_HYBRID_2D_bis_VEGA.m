myclusterSdbis=parcluster('local');
myclusterSdbis.NumWorkers=60;
parpool(myclusterSdbis,60,'SpmdEnabled',false);
Number = 5000;
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.0935; %CNT area fraction
    ...
    RVE.agg_angle = 90; %*/-angle around agglomerate center CNT in degree
...
save('Hybrid_Strain_2D_Vf9.35p_G20p_agg_10p_angle_90d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.0910; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf9.10p_G20p_agg_20p_angle_90d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.0940; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf9.40p_G20p_agg_30p_angle_90d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.0995; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf9.95p_G20p_agg_40p_angle_90d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.1010; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf10.10p_G20p_agg_50p_angle_90d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.1090; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf10.90p_G20p_agg_60p_angle_90d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.1175; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf11.75p_G20p_agg_70p_angle_90d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.1345; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf13.45p_G20p_agg_80p_angle_90d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.2010; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf20.10p_G20p_agg_90p_angle_90d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
