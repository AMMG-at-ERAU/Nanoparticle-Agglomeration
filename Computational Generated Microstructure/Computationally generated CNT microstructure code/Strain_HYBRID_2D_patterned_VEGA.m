...
parfor ii = 1:Number
    ...
    format long
    RVE = [];
    RVE.size = [32,0,160];                       %[Lx,Ly,Lz] mimcrometer
    
    
    
    RVE.Vf = 0.1; %CNT area fraction
    RVE.Vf_agg = 0.00; %percentage of agglomerate CNTs


    RVE.perc = 0.2429/RVE.Vf; %percentage of CNT fraction for GNP particles
    ...
    RVE.ae = 3; %semi major axis of GNP
    RVE.be = 1; %semi minor axis of GNP
    ...
    [ Pgg, gh, PPg ] = GNP_generate_strain_patterned( RVE );%Pgg (ellipse center no BC), gh (angle no BC), PPg (resistor with BC)
    Ngnp = length(gh);
    if Ngnp~=0
...
save('Hybrid_Strain_2D_Vf10p_G24.29p(132)_a-3_b-1_Lx_32_Ly_160_patterned_allatrain_2000.mat','result1','Junct','FLAG')
