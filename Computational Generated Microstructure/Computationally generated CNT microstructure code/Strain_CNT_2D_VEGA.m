mycluster1S=parcluster('local');
mycluster1S.NumWorkers=60;
parpool(mycluster1S,60,'SpmdEnabled',false);
Number = 5000;
...
% 
% 
%     RVE.Vf = 0.0930 + 0.20; %CNT area fraction
...
% end
% save('CNT_Strain_2D_Vf9.30+20p_agg_10p_angle_0d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
% 
% parfor ii = 1:Number
%     rng(ii)
%     format long
...
% 
% 
%     RVE.Vf = 0.0945 + 0.20; %CNT area fraction
...
% %     disp(['// Junct = ',num2str(Junct(ii,:)),' %']);
% end
% save('CNT_Strain_2D_Vf9.45+20p_agg_20p_angle_0d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
% 
% parfor ii = 1:Number
%     rng(ii)
%     format long
...
% %     disp(['// Junct = ',num2str(Junct(ii,:)),' %']);
% end
% save('CNT_Strain_2D_Vf9.55+20p_agg_30p_angle_0d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
% 
% parfor ii = 1:Number
%     rng(ii)
%     format long
...
% 
% 
%     RVE.Vf = 0.10 + 0.20; %CNT area fraction
...
% %     disp(['// Junct = ',num2str(Junct(ii,:)),' %']);
% end
% save('CNT_Strain_2D_Vf10+20p_agg_40p_angle_0d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
% 
% parfor ii = 1:Number
%     rng(ii)
%     format long
...
% 
% 
%     RVE.Vf = 0.1095 + 0.20; %CNT area fraction
...
% %     disp(['// Junct = ',num2str(Junct(ii,:)),' %']);
% end
% save('CNT_Strain_2D_Vf10.95+20p_agg_50p_angle_0d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
% 
% parfor ii = 1:Number
%     rng(ii)
%     format long
...
% %     disp(['// Junct = ',num2str(Junct(ii,:)),' %']);
% end
% save('CNT_Strain_2D_Vf11.30+20p_agg_60p_angle_0d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
% 
% parfor ii = 1:Number
%     rng(ii)
%     format long
...
% %     disp(['// Junct = ',num2str(Junct(ii,:)),' %']);
% end
% save('CNT_Strain_2D_Vf11.75+20p_agg_70p_angle_0d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
% 
% parfor ii = 1:Number
%     rng(ii)
%     format long
...
% 
% 
%     RVE.Vf = 0.1505 + 0.20; %CNT area fraction
...
% %     disp(['// Junct = ',num2str(Junct(ii,:)),' %']);
% end
% save('CNT_Strain_2D_Vf15.05+20p_agg_80p_angle_0d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
...
save('CNT_Strain_2D_Vf24.95+20p_agg_90p_angle_0d_rad_2L-over-100_5000.mat','result1','Junct','FLAG','Rff1')
delete(gcp('nocreate'))
