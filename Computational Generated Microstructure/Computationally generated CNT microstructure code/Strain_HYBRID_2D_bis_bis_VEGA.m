myclusterSdbisbis=parcluster('local');
myclusterSdbisbis.NumWorkers=60;
parpool(myclusterSdbisbis,60,'SpmdEnabled',false);
Number = 5000;
...
parfor ii = 1:Number
    ...
    RVE.agg_angle = 45; %*/-angle around agglomerate center CNT in degree
...
save('Hybrid_Strain_2D_Vf9.55p_G20p_agg_10p_angle_45d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
save('Hybrid_Strain_2D_Vf9.20p_G20p_agg_20p_angle_45d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.0970; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf9.70p_G20p_agg_30p_angle_45d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.0965; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf9.65p_G20p_agg_40p_angle_45d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.1040; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf10.40p_G20p_agg_50p_angle_45d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.1115; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf11.15p_G20p_agg_60p_angle_45d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.1240; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf12.40p_G20p_agg_70p_angle_45d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.1375; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf13.75p_G20p_agg_80p_angle_45d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
...
parfor ii = 1:Number
    ...
    RVE.Vf = 0.2195; %CNT area fraction
...
save('Hybrid_Strain_2D_Vf21.95p_G20p_agg_90p_angle_45d_rad_2L-over-100_5000_P100.mat','result1','Junct','FLAG')
