myclusterHoleCondSquarto=parcluster('local');
myclusterHoleCondSquarto.NumWorkers=36;
parpool(myclusterHoleCondSquarto,35,'SpmdEnabled',true);
...
Data = Data(1);
save('CNT_Hole_Cond_2D_Vf_25p_agg_0p_Hole_rad_(1_1_5)Lover20_number_1_5000.mat','result1','Junct','Junct1','Junct2','FLAG','Data')
