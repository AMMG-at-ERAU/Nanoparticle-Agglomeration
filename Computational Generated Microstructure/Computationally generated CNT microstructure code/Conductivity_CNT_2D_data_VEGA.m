myclusterCond2=parcluster('local');
myclusterCond2.NumWorkers=4;
parpool(myclusterCond2,4,'SpmdEnabled',true);
Number = 4;
...
% 
% 
% % save('CNT_Conductivity_data_2D_Vf_8.70p_agg_10p_rad_12L-over-100_5000.mat','count')
% 
% count = zeros(1,2);
% 
%     parfor ii = 1:Number
...
% 
% 
% % save('CNT_Conductivity_data_2D_Vf_9.05p_agg_20p_rad_12L-over-100_5000.mat','count')
% 
% count = zeros(1,2);
% 
%     parfor ii = 1:Number
...
% 
% 
% % save('CNT_Conductivity_data_2D_Vf_9.45p_agg_30p_rad_12L-over-100_5000.mat','count')
% 
% count = zeros(1,2);
% 
%     parfor ii = 1:Number
...
% 
% 
% % save('CNT_Conductivity_data_2D_Vf_9.40p_agg_40p_rad_12L-over-100_5000.mat','count')
% 
% count = zeros(1,2);
% 
%     parfor ii = 1:Number
...
% 
% 
% % save('CNT_Conductivity_data_2D_Vf_9.50p_agg_50p_rad_12L-over-100_5000.mat','count')
% 
% count = zeros(1,2);
% 
%     parfor ii = 1:Number
...
% 
% 
% % save('CNT_Conductivity_data_2D_Vf_9.90p_agg_60p_rad_12L-over-100_5000.mat','count')
% 
% count = zeros(1,2);
% 
%     parfor ii = 1:Number
...
% 
% 
% % save('CNT_Conductivity_data_2D_Vf_10.55p_agg_70p_rad_12L-over-100_5000.mat','count')
% 
% count = zeros(1,2);
% 
%     parfor ii = 1:Number
...
% 
% 
% % save('CNT_Conductivity_data_2D_Vf_11.35p_agg_80p_rad_12L-over-100_5000.mat','count')
% 
% count = zeros(1,2);
% 
%     parfor ii = 1:Number
...
% 
% 
% %save('CNT_Conductivity_data_2D_Vf_15.4p_agg_90p_rad_12L-over-100_5000.mat','count')
% delete(gcp('nocreate'))