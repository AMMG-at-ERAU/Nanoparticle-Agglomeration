mycluster1bis=parcluster('local');
mycluster1bis.NumWorkers=60;
parpool(mycluster1bis,60,'SpmdEnabled',false);
Number = 5000;
%Vof = [0.02:0.003:0.16 0.2:0.05:0.4];
Vof = [0.134:0.003:0.16 0.2:0.05:0.4];
lVof = length(Vof);
count = zeros(lVof,3);
for jj = 1:lVof
...
save('CNT_Cond_data_2D_agg_80p_angle_0d_rad_2L-over-100_5000.mat','count')
end
%save('CNT_Cond_data_2D_agg_80p_angle_0d_rad_2L-over-100_5000.mat','count')
