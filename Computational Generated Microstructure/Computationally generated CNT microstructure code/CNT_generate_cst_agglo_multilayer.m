function [  Ptrue, Center, Length, Angle, Ptrue1, Center1, Length1 ] = CNT_generate_cst_agglo_multilayer( RVE)
...
while Vpr<RVE.Vf*Lx*Lz*(1-RVE.Vf_agg) %generation of non agglomerated CNTs
    ...
    [P, center1, li1] = PBC_2D_multilayer(pt,RVE);
