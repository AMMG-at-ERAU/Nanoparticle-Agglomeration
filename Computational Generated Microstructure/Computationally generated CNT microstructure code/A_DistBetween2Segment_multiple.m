...
function [distance] = A_DistBetween2Segment_multiple(p1, p2, p3, p4,dvdw,Dia)
...
%     dti = sqrt(sum(v1.*v1,2))+0.1;        %I have added 0.1 so that the value won't be zer0 when the intersection is p1 or p3. I will subtract it
%     dta = sqrt(sum(v2.*v2,2))+0.1;        %every time before using the value
